    ...
    const seed = [
      {
        id: 'not_1',
        group: 'Today',
        title: 'Ahmad Ibrahim logged meal',
        subtitle: 'Review Nasi Lemak log',
        time: '10:00 AM',
        isUnread: true,
        emoji: '🥗',
      ...
      },
      {
        id: 'not_2',
        group: 'Today',
        title: 'Mei Ling requested reschedule',
        subtitle: 'Wants change to slot timing',
        time: '10:30 AM',
        isUnread: true,
        emoji: '📅',
      ...
      },
      {
        id: 'not_3',
        group: 'Today',
        title: 'Faizul invoice pending',
        subtitle: 'Monthly subscription alert',
        time: '11:25 AM',
        isUnread: true,
        emoji: '💳',
      ...
      },
      {
        ...
        subtitle: 'Ahmad Ibrahim: HIIT Core',
        time: '05:00 PM',
        isUnread: false,
        emoji: '✅',
    ...
    const seed = [
      {
        ...
        subtitle: 'HIIT Core on 20 Jun @ 10:00 AM, SS15 Selangor.',
        time: '09:15 AM',
        isUnread: true,
        emoji: '📅',
        bgColor: 'bg-indigo-50 text-indigo-650 border border-indigo-100',
      ...
      },
      {
        ...
        subtitle: 'Coach commented on your Nasi Lemak Biasa log.',
        time: '10:45 AM',
        isUnread: true,
        emoji: '🥗',
        bgColor: 'bg-emerald-50 text-emerald-650 border border-emerald-100',
      ...
      },
      {
        ...
        subtitle: 'Reschedule request sent to Coach Sarah Tan.',
        time: '11:30 AM',
        isUnread: false,
        emoji: '⏳',
        bgColor: 'bg-amber-50 text-amber-650 border border-amber-100',
      ...
      },
      {
        ...
        subtitle: 'RM600 paid for 8 Classes Monthly package.',
        time: '02:00 PM',
        isUnread: false,
        emoji: '✅',
      ...
      },
      {
        ...
        subtitle: 'Invoice for 8 Classes from Coach Sarah Tan.',
        time: '09:00 AM',
        isUnread: true,
        emoji: '🧾',
        bgColor: 'bg-purple-50 text-purple-650 border border-purple-100',
